...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
 ...
 <?php } else {?>
   ...
   <div class="post-thumbnail inside-banner">
     1-<img width="1200" height="270" src="/wp-content/themes/twentysixteen-child/images/bureau-communal-semsales.jpg" class="attachment-insideBanner-size size-insideBanner-size wp-post-image" alt="">
   </div>
	<?php } ?>
<?php endwhile; ?>
<?php endif; ?>
