...
<?php } else {?>
  ...
  <div class="post-thumbnail inside-banner">
    4-<img width="1200" height="270" src="/wp-content/themes/twentysixteen-child/images/bureau-communal-semsales.jpg" class="attachment-insideBanner-size size-insideBanner-size wp-post-image" alt="">
  </div>
 <?php } ?>
